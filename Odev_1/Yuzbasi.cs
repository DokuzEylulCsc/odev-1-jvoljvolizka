...
namespace Odev_1
{
    class Yuzbasi : Asker
    {
        ...
        {
            if (Koordinat.X + 3 != 15 && harita[Koordinat.X + 3, Koordinat.Y] != null && harita[Koordinat.X + 3, Koordinat.Y].asker.takimid != this.takimid)
            {
                int sal;
                ...
                int newcan = harita[Koordinat.X + 3, Koordinat.Y].asker.health - sal;
                if (newcan < 0)
                {
                    Console.WriteLine(harita[Koordinat.X + 3, Koordinat.Y].asker.takimid + " takimindan " + harita[Koordinat.X + 3, Koordinat.Y].asker.typeid + " oldu");
                    harita[Koordinat.X + 3, Koordinat.Y] = null;


                }
                else
                {
                    harita[Koordinat.X + 3, Koordinat.Y].asker.health = newcan;
                }
            }

            else if (Koordinat.Y + 3 != 15 && harita[Koordinat.X, Koordinat.Y + 3] != null && harita[Koordinat.X, Koordinat.Y + 3].asker.takimid != this.takimid)
            {
                int sal;
                Random rnd = new Random();
                int num = rnd.Next(3);
                ...
                int newcan = harita[Koordinat.X, Koordinat.Y + 3].asker.health - sal;
                if (newcan < 0)
                {
                    Console.WriteLine(harita[Koordinat.X, Koordinat.Y + 3].asker.takimid + " takimindan " + harita[Koordinat.X, Koordinat.Y + 3].asker.typeid + " oldu");
                    harita[Koordinat.X, Koordinat.Y + 3] = null;

                }
                else
                {
                    harita[Koordinat.X, Koordinat.Y + 3].asker.health = newcan;
                }
            }
            else if (Koordinat.X - 3 != 0 && harita[Koordinat.X - 3, Koordinat.Y] != null && harita[Koordinat.X - 3, Koordinat.Y].asker.takimid != this.takimid)
            {
                int sal;
                Random rnd = new Random();
                int num = rnd.Next(3);
